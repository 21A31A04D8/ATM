#----Atm project without file handling----
class ATM:
    def __init__(self):
        self.Username = ['krishna', 'kumar', 'kaushik', 'nawaz']
        self.Password = ['abc123', 'ab12', 'abc12', '111']
        self.Pin = [1234, 2345, 3456, 8999]
        self.count = 0
        self.U_password = ''
        self.option = 0
    ...
    def Login(self):
        ...
        if self.U_name not in self.Username:
